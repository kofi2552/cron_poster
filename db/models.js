...
// DailyContext model (stores real user context recorded daily for a topic)
export const DailyContext = sequelize.define(
  "DailyContext",
  {
    id: {
      type: DataTypes.UUID,
...
User.hasMany(DailyContext, { foreignKey: "userId", onDelete: "CASCADE" });
DailyContext.belongsTo(User, { foreignKey: "userId" });
Topic.hasMany(DailyContext, { foreignKey: "topicId", onDelete: "CASCADE" });
DailyContext.belongsTo(Topic, { foreignKey: "topicId" });
